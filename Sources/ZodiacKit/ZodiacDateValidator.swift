...
public struct ZodiacDateValidator: ZodiacValidator {
	...
	public func validate(zodiacs: [Zodiac]) throws {
		...
		if uniqueZodiacs.count != Sign.allCases.count {
	...
	private func sortZodiacs(zodiacs: [Zodiac]) -> [Zodiac] {
	...
	private func findMissingDates(startMonth: Int, startDay: Int, endMonth: Int, endDay: Int) -> [DateComponents] {
		let calendar = Calendar.current
		let startDate = calendar.date(from: DateComponents(year: leapYear, month: startMonth, day: startDay))!
		let endDate = calendar.date(from: DateComponents(year: leapYear, month: endMonth, day: endDay))!
